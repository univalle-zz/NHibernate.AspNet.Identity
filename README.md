[![Stories in Ready](https://badge.waffle.io/univalle-zz/NHibernate.AspNet.Identity.png?label=ready&title=Ready)](https://waffle.io/univalle-zz/NHibernate.AspNet.Identity)
